...
st.set_page_config(page_title='FLUX IDEAS | THE STARTUP BUILDER', page_icon='⚡', layout='wide', initial_sidebar_state='collapsed')
...
<div style='text-align:center; margin-bottom:60px;'>
    <h1 class='flux-title'>FLUX IDEAS</h1>
    <p class='flux-tagline'>THE STARTUP BUILDER</p>
</div>
""", unsafe_allow_html=True)
...
if st.session_state.app_stage == "processing1":
    with st.status("⚡ FLUX IDEAS Intelligence Pipeline Active...", expanded=True) as status:
        # Pre-flight Check
